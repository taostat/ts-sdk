...
import {
  ...
  GetBlocksParams,
  BlockIntervalData,
  GetBlockNumbersByIntervalParams,
  ExtrinsicData,
  GetExtrinsicsParams,
  EventData,
  GetEventsParams,
  ...
  RuntimeVersionData,
  GetRuntimeVersionHistoryParams,
  ProxyCallData,
  GetProxyCallsParams,
} from './types';
...
export class ChainModule {
  ...
  ): Promise<ApiResponse<PaginatedResponse<BlockData>>> {
    return this.httpClient.get<PaginatedResponse<BlockData>>(
      '/api/block/v1',
      params
    );
  }
   ...
   */
  async getBlockNumbersByInterval(
    params: GetBlockNumbersByIntervalParams
  ): Promise<ApiResponse<PaginatedResponse<BlockIntervalData>>> {
    return this.httpClient.get<PaginatedResponse<BlockIntervalData>>(
  ...
  ): Promise<ApiResponse<PaginatedResponse<ExtrinsicData>>> {
    return this.httpClient.get<PaginatedResponse<ExtrinsicData>>(
      '/api/extrinsic/v1',
      params
    );
  }
  ...
  ): Promise<ApiResponse<PaginatedResponse<EventData>>> {
    return this.httpClient.get<PaginatedResponse<EventData>>(
      '/api/event/v1',
      params
    );
  }
   ...
   */
  async getChainCalls(
    params?: GetChainCallsParams
  ): Promise<ApiResponse<PaginatedResponse<ChainCallData>>> {
    return this.httpClient.get<PaginatedResponse<ChainCallData>>(
      '/api/call/v1',
      params
    );
  }
  ...
  async getLatestStats(): Promise<
    ApiResponse<PaginatedResponse<NetworkStatsData>>
  > {
    return this.httpClient.get<PaginatedResponse<NetworkStatsData>>(
      '/api/stats/latest/v1'
    );
  }
  ...
  ): Promise<ApiResponse<PaginatedResponse<NetworkStatsData>>> {
    return this.httpClient.get<PaginatedResponse<NetworkStatsData>>(
  ...
  async getRuntimeVersion(): Promise<
    ApiResponse<PaginatedResponse<RuntimeVersionData>>
  > {
    return this.httpClient.get<PaginatedResponse<RuntimeVersionData>>(
  ...
  async getRuntimeVersionHistory(
    params?: GetRuntimeVersionHistoryParams
  ): Promise<ApiResponse<PaginatedResponse<RuntimeVersionData>>> {
    return this.httpClient.get<PaginatedResponse<RuntimeVersionData>>(
   ...
   */
  async getProxyCalls(
    params?: GetProxyCallsParams
  ): Promise<ApiResponse<PaginatedResponse<ProxyCallData>>> {
    return this.httpClient.get<PaginatedResponse<ProxyCallData>>(
      '/api/proxy_call/v1',
      params
    );
  }
