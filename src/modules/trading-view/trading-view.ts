...
import { TradingViewUDFResponse, GetTradingViewHistoryParams } from './types';
...
export class TradingViewModule {
  ...
  async getTradingViewHistory(
    params: GetTradingViewHistoryParams
  ): Promise<ApiResponse<TradingViewUDFResponse>> {
    return this.httpClient.get<TradingViewUDFResponse>(
