...
export class AccountsModule {
  ...
  ): Promise<ApiResponse<PaginatedResponse<AccountData>>> {
    return this.httpClient.get<PaginatedResponse<AccountData>>(
  ...
  ): Promise<ApiResponse<PaginatedResponse<TransferData>>> {
    return this.httpClient.get<PaginatedResponse<TransferData>>(
      '/api/transfer/v1',
      params
    );
  }
  ...
  async getOnChainIdentity(
    params?: GetOnChainIdentityParams
  ): Promise<ApiResponse<PaginatedResponse<OnChainIdentityData>>> {
    return this.httpClient.get<PaginatedResponse<OnChainIdentityData>>(
   ...
   */
  async getPendingColdkeySwap(): Promise<
    ApiResponse<PendingColdkeySwapResponse>
  > {
    return this.httpClient.get<PendingColdkeySwapResponse>(
