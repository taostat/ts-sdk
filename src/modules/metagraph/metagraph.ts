...
export class MetagraphModule {
   ...
   */
  async getMinerIncentiveDistributionBySubnet(
    params: GetMinerIncentiveDistributionBySubnetParams
  ): Promise<ApiResponse<MinerIncentiveDistributionResponse>> {
    return this.httpClient.get<MinerIncentiveDistributionResponse>(
   ...
   */
  async getSubnetAxonIpDistribution(
    params: GetSubnetAxonIpDistributionParams
  ): Promise<ApiResponse<SubnetAxonIpDistributionResponse>> {
    return this.httpClient.get<SubnetAxonIpDistributionResponse>(
  ...
  async getSubnetColdkeyDistribution(
    params: GetSubnetColdkeyDistributionParams
  ): Promise<ApiResponse<SubnetColdkeyDistributionResponse>> {
    return this.httpClient.get<SubnetColdkeyDistributionResponse>(
   ...
   */
  async getLatestMinerWeight(
    params: GetLatestMinerWeightParams
  ): Promise<ApiResponse<LatestMinerWeightResponse>> {
    return this.httpClient.get<LatestMinerWeightResponse>(
   ...
   */
  async getMinerWeightHistory(
    params: GetMinerWeightHistoryParams
  ): Promise<ApiResponse<MinerWeightHistoryResponse>> {
    return this.httpClient.get<MinerWeightHistoryResponse>(
   ...
   */
  async getNeuronDeregistrations(
    params?: GetNeuronDeregistrationsParams
  ): Promise<ApiResponse<NeuronDeregistrationsResponse>> {
    return this.httpClient.get<NeuronDeregistrationsResponse>(
   ...
   */
  async getNeuronRegistrations(
    params?: GetNeuronRegistrationsParams
  ): Promise<ApiResponse<NeuronRegistrationsResponse>> {
    return this.httpClient.get<NeuronRegistrationsResponse>(
   ...
   */
  async getRootSubnetHistory(
    params?: GetRootSubnetHistoryParams
  ): Promise<ApiResponse<RootSubnetHistoryResponse>> {
    return this.httpClient.get<RootSubnetHistoryResponse>(
   ...
   */
  async getRootSubnet(
    params?: GetRootSubnetParams
  ): Promise<ApiResponse<RootSubnetResponse>> {
    return this.httpClient.get<RootSubnetResponse>(
  ...
  ): Promise<ApiResponse<MetagraphHistoryResponse>> {
    return this.httpClient.get<MetagraphHistoryResponse>(
  ...
  ): Promise<ApiResponse<MetagraphLatestResponse>> {
    return this.httpClient.get<MetagraphLatestResponse>(
