...
export class ValidatorsModule {
   ...
   */
  async getYield(
    params?: GetYieldParams
  ): Promise<ApiResponse<ValidatorYieldResponse>> {
    return this.httpClient.get<ValidatorYieldResponse>(
  ...
  async getValidatorsInSubnet(
    params: GetValidatorsInSubnetParams
  ): Promise<ApiResponse<ValidatorsInSubnetResponse>> {
    return this.httpClient.get<ValidatorsInSubnetResponse>(
  ...
  async getWeightCopiers(
    params?: GetWeightCopiersParams
  ): Promise<ApiResponse<WeightCopiersResponse>> {
    return this.httpClient.get<WeightCopiersResponse>(
   ...
   */
  async getAlphaSharesHistory(
    params?: GetAlphaSharesHistoryParams
  ): Promise<ApiResponse<AlphaSharesHistoryResponse>> {
    return this.httpClient.get<AlphaSharesHistoryResponse>(
   ...
   */
  async getAlphaSharesLatest(
    params?: GetAlphaSharesLatestParams
  ): Promise<ApiResponse<AlphaSharesLatestResponse>> {
    return this.httpClient.get<AlphaSharesLatestResponse>(
  ...
  async getWeightsHistory(
    params?: GetWeightsHistoryParams
  ): Promise<ApiResponse<WeightsHistoryResponse>> {
    return this.httpClient.get<WeightsHistoryResponse>(
   ...
   */
  async getWeightsLatest(
    params?: GetWeightsLatestParams
  ): Promise<ApiResponse<WeightsLatestResponse>> {
    return this.httpClient.get<WeightsLatestResponse>(
  ...
  ): Promise<ApiResponse<ValidatorPerformanceResponse>> {
    return this.httpClient.get<ValidatorPerformanceResponse>(
  ...
  async getdTaoValidatorPerformanceLatest(
    params: GetdTaoValidatorPerformanceLatestParams
  ): Promise<ApiResponse<DTaoValidatorPerformanceLatestResponse>> {
    return this.httpClient.get<DTaoValidatorPerformanceLatestResponse>(
  ...
  async getdTaoValidatorPerformanceHistory(
    params: GetdTaoValidatorPerformanceHistoryParams
  ): Promise<ApiResponse<DTaoValidatorPerformanceHistoryResponse>> {
    return this.httpClient.get<DTaoValidatorPerformanceHistoryResponse>(
  ...
  async getMetricsLatest(
    params?: GetMetricsLatestParams
  ): Promise<ApiResponse<ValidatorMetricsLatestResponse>> {
    return this.httpClient.get<ValidatorMetricsLatestResponse>(
  ...
  ): Promise<ApiResponse<ValidatorMetricsHistoryResponse>> {
    return this.httpClient.get<ValidatorMetricsHistoryResponse>(
   ...
   */
  async getParentChildHotkeyRelationsLatest(
    params?: GetParentChildHotkeyRelationsLatestParams
  ): Promise<ApiResponse<ParentChildHotkeyRelationsLatestResponse>> {
    return this.httpClient.get<ParentChildHotkeyRelationsLatestResponse>(
   ...
   */
  async getParentChildHotkeyRelationsHistory(
    params?: GetParentChildHotkeyRelationsHistoryParams
  ): Promise<ApiResponse<ParentChildHotkeyRelationsHistoryResponse>> {
    return this.httpClient.get<ParentChildHotkeyRelationsHistoryResponse>(
   ...
   */
  async getValidatorLatest(
    params?: GetValidatorLatestParams
  ): Promise<ApiResponse<ValidatorLatestResponse>> {
    return this.httpClient.get<ValidatorLatestResponse>(
   ...
   */
  async getdTaoValidatorLatest(
    params?: GetdTaoValidatorLatestParams
  ): Promise<ApiResponse<dTaoValidatorLatestResponse>> {
    return this.httpClient.get<dTaoValidatorLatestResponse>(
  ...
  async getValidatorHistory(
    params?: GetValidatorHistoryParams
  ): Promise<ApiResponse<ValidatorHistoryResponse>> {
    return this.httpClient.get<ValidatorHistoryResponse>(
  ...
  async getdTaoValidatorHistory(
    params?: GetdTaoValidatorHistoryParams
  ): Promise<ApiResponse<dTaoValidatorHistoryResponse>> {
    return this.httpClient.get<dTaoValidatorHistoryResponse>(
