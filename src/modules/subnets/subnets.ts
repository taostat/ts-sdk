...
import {
  SubnetsQueryParams,
  SubnetsResponse,
  HistoricalSubnetPricesQueryParams,
  HistoricalSubnetPricesResponse,
  LatestSubnetPricesResponse,
  SubnetRegistrationsQueryParams,
  SubnetRegistrationsResponse,
  RegistrationCostHistoryQueryParams,
  RegistrationCostHistoryResponse,
  CurrentRegistrationCostResponse,
  SubnetOwnerQueryParams,
  SubnetOwnerResponse,
  SubnetIdentityQueryParams,
  SubnetIdentityResponse,
  SubnetEmissionQueryParams,
  SubnetEmissionResponse,
  SubnetsPoolsHistoryQueryParams,
  SubnetsPoolsHistoryResponse,
  CurrentSubnetPoolsQueryParams,
  CurrentSubnetPoolsResponse,
...
export class SubnetsModule {
   ...
   */
  async getSubnets(
    params?: SubnetsQueryParams
  ): Promise<ApiResponse<SubnetsResponse>> {
    return this.httpClient.get<SubnetsResponse>(
   ...
   */
  async getHistoricalSubnetPricesSum(
    params?: HistoricalSubnetPricesQueryParams
  ): Promise<ApiResponse<HistoricalSubnetPricesResponse>> {
    return this.httpClient.get<HistoricalSubnetPricesResponse>(
   ...
   */
  async getLatestSubnetPricesSum(): Promise<
    ApiResponse<LatestSubnetPricesResponse>
  > {
    return this.httpClient.get<LatestSubnetPricesResponse>(
  ...
  async getSubnetRegistrations(
    params?: SubnetRegistrationsQueryParams
  ): Promise<ApiResponse<SubnetRegistrationsResponse>> {
    return this.httpClient.get<SubnetRegistrationsResponse>(
  ...
  ): Promise<ApiResponse<RegistrationCostHistoryResponse>> {
    return this.httpClient.get<RegistrationCostHistoryResponse>(
   ...
   */
  async getCurrentSubnetRegistrationCost(): Promise<
    ApiResponse<CurrentRegistrationCostResponse>
  > {
    return this.httpClient.get<CurrentRegistrationCostResponse>(
  ...
  async getSubnetOwner(
    params?: SubnetOwnerQueryParams
  ): Promise<ApiResponse<SubnetOwnerResponse>> {
    return this.httpClient.get<SubnetOwnerResponse>(
      '/api/subnet/owner/v1',
      params
    );
  }
   ...
   */
  async getSubnetIdentity(
    params?: SubnetIdentityQueryParams
  ): Promise<ApiResponse<SubnetIdentityResponse>> {
    return this.httpClient.get<SubnetIdentityResponse>(
  ...
  ): Promise<ApiResponse<SubnetEmissionResponse>> {
    return this.httpClient.get<SubnetEmissionResponse>(
   ...
   */
  async getSubnetsPoolsHistory(
    params?: SubnetsPoolsHistoryQueryParams
  ): Promise<ApiResponse<SubnetsPoolsHistoryResponse>> {
    return this.httpClient.get<SubnetsPoolsHistoryResponse>(
   ...
   */
  async getCurrentSubnetPools(
    params?: CurrentSubnetPoolsQueryParams
  ): Promise<ApiResponse<CurrentSubnetPoolsResponse>> {
    return this.httpClient.get<CurrentSubnetPoolsResponse>(
  ...
  async getSubnetHistory(
    params: SubnetHistoryQueryParams
  ): Promise<ApiResponse<SubnetHistoryResponse>> {
    return this.httpClient.get<SubnetHistoryResponse>(
